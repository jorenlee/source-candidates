<template>
  <div>
    <div class="lg:mt-14 mt-5 mx-auto">
      <div class="mb-5 mx-auto block lg:w-2/12 w-4/12">
        <ul class="flex justify-between gap-5">
          <li>
            <img class="rounded-full object-cover object-center lg:w-20" src="@/assets/logo/lsu-logo.jpg" alt="" />
          </li>
          <li>
            <img class="rounded-full object-cover object-center lg:w-20" src="@/assets/logo/source-logo.jpg" alt="" />
          </li>
        </ul>
      </div>
      <h1 class="text-center mb-14 text-xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600 lg:w-11/12 w-4/5 mx-auto">LSU Student Organization Utilizing the Realm of Computer Eclecticism <br>Election for A.Y. 2022-2023</h1>
      <div class="mx-auto mb-20 lg:w-9/12 w-11/12">
        <div class="lg:grid lg:grid-cols-2 lg:gap-10 lg:justify-evenly">
          <!-- card-1 -->
            <div class="relative lg:w-10/12 w-11/12 mx-auto lg:mb-0 mb-10" v-for="(student, i) in students" :key="i">
              <!-- box-1 -->
              <div class="px-2">
                <div class="flex h-8 w-full rounded-t-lg border-b-2 border-slate-300 bg-green-800 shadow-lg">
                  <small class="ml-24 pt-1.5 w-full text-sm font-light tracking-tight text-white whitespace-nowrap">FOR
              ...
              <div class="bg-gradient-to-r from-green-900 to-green-500 flex h-12 w-full rounded-lg bg-white shadow-xl">
                <div class="ml-16 mt-2">
                  <small class="text-lg text-white font-bold whitespace-nowrap mr-5 ml-10">{{student.name}}</small> 
                  <span class="text-xs mt-3.5 text-white whitespace-nowrap">{{student.courseAndYear}}</span>
                </div>
              </div>
              <!-- circle -->
              <div class="absolute bg-white top-2 left-6 h-16 w-16 overflow-hidden rounded-full border-2 border-white shadow-md">
